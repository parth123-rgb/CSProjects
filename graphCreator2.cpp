...
void printShortestPath(int nodeBefore[], char labels[], int currentNode);
...
// finding the vertext which HAS NOT been visited.
    ...
    cout << "SHORTEST PATH PRINT OUT: " << endl;
    printShortestPath(nodeBefore, labels, nextIndex);
    }
     }
}
...
void printShortestPath(int nodeBefore[], char labels[], int currentNode) {
    ...
    printShortestPath(nodeBefore, labels, nodeBefore[currentNode]);
    
    cout << labels[currentNode] << " ";
}
